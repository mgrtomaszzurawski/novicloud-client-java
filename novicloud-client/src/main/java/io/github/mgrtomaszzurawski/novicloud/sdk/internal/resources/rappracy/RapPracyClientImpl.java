 ...
 */
package io.github.mgrtomaszzurawski.novicloud.sdk.internal.resources.rappracy;
 ...
 * @since 2.0.0
 */
public final class RapPracyClientImpl implements RapPracyClient {
    ...
    public RapPracyClientImpl(ApiClient apiClient, String accountName, RetryPolicy retryPolicy) {
    ...
    public PagedResult<RaportPracy> list(RapPracyQueryBuilder query) {
        ...
        return PagedResult.of(
                ...
                p -> {
                    var items = p.getDane();
                    return items == null ? List.of() : items.stream().map(RawMappers::toRaportPracy).toList();
                },
                RapPracyClientImpl::extractSelfLink,
