 ...
 */
package io.github.mgrtomaszzurawski.novicloud.sdk.internal.resources.jmiary;
 ...
 * @since 2.0.0
 */
public final class JmiaryClientImpl implements JmiaryClient {
    ...
    private static final String RESOURCE_NAME = "jmiara";
    ...
    public JmiaryClientImpl(ApiClient apiClient, String accountName, RetryPolicy retryPolicy) {
    ...
    public PagedResult<Jmiary> list(JmiaryQueryBuilder query) {
        ...
        return PagedResult.of(
                ...
                p -> {
                    var items = p.getDane();
                    return items == null ? List.of() : items.stream().map(RawMappers::toJmiary).toList();
                },
                JmiaryClientImpl::extractSelfLink,
    ...
    public Jmiary getById(Long id) {
        ...
        return RawMappers.toJmiary(NoviCloudException.requireDane(raw, RESOURCE_NAME, id));
    }
