 ...
 */
package io.github.mgrtomaszzurawski.novicloud.sdk.internal.resources.kartyloj;
 ...
 * @since 2.0.0
 */
public final class KartyLojClientImpl implements KartyLojClient {
    ...
    private static final String RESOURCE_NAME = "karta lojalnosciowa";
    ...
    public KartyLojClientImpl(ApiClient apiClient, String accountName, RetryPolicy retryPolicy) {
    ...
    public PagedResult<KartaLojalnosciowa> list(KartaLojQueryBuilder query) {
        ...
        return PagedResult.of(
                ...
                p -> {
                    var items = p.getDane();
                    return items == null ? List.of() : items.stream().map(RawMappers::toKartaLojalnosciowa).toList();
                },
                KartyLojClientImpl::extractSelfLink,
    ...
    public KartaLojalnosciowa getByKod(String kod) {
        ...
        return RawMappers.toKartaLojalnosciowa(NoviCloudException.requireDane(raw, RESOURCE_NAME, kod));
    }
