 ...
 */
package io.github.mgrtomaszzurawski.novicloud.sdk.internal.resources.waluty;
 ...
 * @since 2.0.0
 */
public final class WalutyClientImpl implements WalutyClient {
    ...
    private static final String RESOURCE_NAME = "waluta";
    ...
    public WalutyClientImpl(ApiClient apiClient, String accountName, RetryPolicy retryPolicy) {
    ...
    public PagedResult<Waluta> list(WalutaQueryBuilder query) {
        ...
        return PagedResult.of(
                ...
                p -> {
                    var items = p.getDane();
                    return items == null ? List.of() : items.stream().map(RawMappers::toWaluta).toList();
                },
                WalutyClientImpl::extractSelfLink,
    ...
    public Waluta getById(Long id) {
        ...
        return RawMappers.toWaluta(NoviCloudException.requireDane(raw, RESOURCE_NAME, id));
    }
