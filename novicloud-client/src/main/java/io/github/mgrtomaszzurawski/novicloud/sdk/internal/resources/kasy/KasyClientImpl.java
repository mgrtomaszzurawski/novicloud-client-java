 ...
 */
package io.github.mgrtomaszzurawski.novicloud.sdk.internal.resources.kasy;
 ...
 * @since 2.0.0
 */
public final class KasyClientImpl implements KasyClient {
    ...
    private static final String RESOURCE_NAME = "kasa";
    ...
    public KasyClientImpl(ApiClient apiClient, String accountName, RetryPolicy retryPolicy) {
    ...
    public PagedResult<Kasa> list(KasaQueryBuilder query) {
        ...
        return PagedResult.of(
                ...
                p -> {
                    var items = p.getDane();
                    return items == null ? List.of() : items.stream().map(RawMappers::toKasa).toList();
                },
                KasyClientImpl::extractSelfLink,
    ...
    public Kasa getById(Long id) {
        ...
        return RawMappers.toKasa(NoviCloudException.requireDane(raw, RESOURCE_NAME, id));
    }
