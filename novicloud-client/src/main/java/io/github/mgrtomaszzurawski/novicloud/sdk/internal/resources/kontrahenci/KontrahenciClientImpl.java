 ...
 */
package io.github.mgrtomaszzurawski.novicloud.sdk.internal.resources.kontrahenci;
 ...
 * @since 2.0.0
 */
public final class KontrahenciClientImpl implements KontrahenciClient {
    ...
    private static final String RESOURCE_NAME = "kontrahent";
    ...
    public KontrahenciClientImpl(ApiClient apiClient, String accountName, RetryPolicy retryPolicy) {
    ...
    public PagedResult<Kontrahent> list(KontrahentQueryBuilder query) {
        ...
        return PagedResult.of(
                ...
                p -> {
                    var items = p.getDane();
                    return items == null ? List.of() : items.stream().map(RawMappers::toKontrahent).toList();
                },
                KontrahenciClientImpl::extractSelfLink,
    ...
    public Kontrahent getById(Long id) {
        ...
        return RawMappers.toKontrahent(NoviCloudException.requireDane(raw, RESOURCE_NAME, id));
    }
