 ...
 */
package io.github.mgrtomaszzurawski.novicloud.sdk.internal.resources.stanymag;
 ...
 * @since 2.0.0
 */
public final class StanyMagClientImpl implements StanyMagClient {
...
private static final String ERR_BUILDER_NULL = "builder must not be null";
    ...
    private static final String RESOURCE_NAME = "stan magazynowy";
    ...
    public StanyMagClientImpl(ApiClient apiClient, String accountName, RetryPolicy retryPolicy) {
    ...
    public PagedResult<StanMag> list(StanMagQueryBuilder query) {
        ...
        return PagedResult.of(
                ...
                p -> {
                    var items = p.getDane();
                    return items == null ? List.of() : items.stream().map(RawMappers::toStanMag).toList();
                },
                StanyMagClientImpl::extractSelfLink,
    ...
    public java.util.List<StanMag> listByTowar(Long idTowaru, String naDzien) {
        ...
        return dane.stream().map(RawMappers::toStanMag).toList();
    }
    ...
    public StanMag getByTowarAndSklep(Long idTowaru, Long idSklepu, String naDzien) {
        ...
        return RawMappers.toStanMag(NoviCloudException.requireDane(raw, RESOURCE_NAME, idTowaru + "/" + idSklepu));
    }
