 ...
 */
package io.github.mgrtomaszzurawski.novicloud.sdk.internal.resources.sprzedaz;
 ...
 * @since 2.0.0
 */
public final class SprzedazClientImpl implements SprzedazClient {
    ...
    private static final String RESOURCE_NAME = "sprzedaz";
    ...
    public SprzedazClientImpl(ApiClient apiClient, String accountName, RetryPolicy retryPolicy) {
    ...
    public PagedResult<Sprzedaz> list(SprzedazQueryBuilder query) {
        ...
        return PagedResult.of(
                ...
                p -> {
                    var items = p.getDane();
                    return items == null ? List.of() : items.stream().map(RawMappers::toSprzedaz).toList();
                },
                SprzedazClientImpl::extractSelfLink,
    ...
    public Sprzedaz getById(Long id) {
        ...
        return RawMappers.toSprzedaz(NoviCloudException.requireDane(raw, RESOURCE_NAME, id));
    }
