 ...
 */
package io.github.mgrtomaszzurawski.novicloud.sdk.internal.resources.rapsprzed;
 ...
 * @since 2.0.0
 */
public final class RapSprzedClientImpl implements RapSprzedClient {
    ...
    public RapSprzedClientImpl(ApiClient apiClient, String accountName, RetryPolicy retryPolicy) {
    ...
    public PagedResult<RaportSprzedazy> list(RapSprzedQueryBuilder query) {
        ...
        return PagedResult.of(
                ...
                p -> {
                    var items = p.getDane();
                    return items == null ? List.of() : items.stream().map(RawMappers::toRaportSprzedazy).toList();
                },
                RapSprzedClientImpl::extractSelfLink,
