 ...
 * @since 1.0.0
 */
public final class StawkiVatClient {
    ...
    public StawkiVatClient(ApiClient apiClient, String accountName, RetryPolicy retryPolicy) {
    ...
    public PagedResult<StawkaVat> list(StawkaVatQueryBuilder query) {
        ...
        return PagedResult.of(
                ...
                p -> {
                    var items = p.getDane();
                    return items == null ? List.of() : items.stream().map(StawkaVat::from).toList();
                },
                StawkiVatClient::extractSelfLink,
