 ...
 */
package io.github.mgrtomaszzurawski.novicloud.sdk.internal.resources.formyplatn;
 ...
 * @since 2.0.0
 */
public final class FormyPlatnClientImpl implements FormyPlatnClient {
    ...
    private static final String RESOURCE_NAME = "forma platn";
    ...
    public FormyPlatnClientImpl(ApiClient apiClient, String accountName, RetryPolicy retryPolicy) {
    ...
    public PagedResult<FormaPlatn> list(FormaPlatnQueryBuilder query) {
        ...
        return PagedResult.of(
                ...
                p -> {
                    var items = p.getDane();
                    return items == null ? List.of() : items.stream().map(RawMappers::toFormaPlatn).toList();
                },
                FormyPlatnClientImpl::extractSelfLink,
    ...
    public FormaPlatn getById(Long id) {
        ...
        return RawMappers.toFormaPlatn(NoviCloudException.requireDane(raw, RESOURCE_NAME, id));
    }
