...
/**
 * Immutable data transfer object for updating an existing kontrahent record.
 * The {@code id} field identifies the record to update and is required.
 *
 * <p>Use {@link Builder} to construct an instance.
 * @since 1.0.0
 */
public final class KontrahentUpdateBuilder {
    ...
    private KontrahentUpdateBuilder(Builder builder) {
        this.id = builder.id;
    ...
    /**
     * Builder for {@link KontrahentUpdateBuilder}.
     */
    public static final class Builder {
        ...
        /**
         * Builds the {@link KontrahentUpdateBuilder}.
         *
         * @return a new {@link KontrahentUpdateBuilder} instance
         */
        public KontrahentUpdateBuilder build() { return new KontrahentUpdateBuilder(this); }
    }
}
