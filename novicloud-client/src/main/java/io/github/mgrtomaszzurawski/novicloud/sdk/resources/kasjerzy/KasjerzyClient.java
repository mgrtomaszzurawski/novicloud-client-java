 ...
 * @since 1.0.0
 */
public final class KasjerzyClient {
    ...
    public KasjerzyClient(ApiClient apiClient, String accountName, RetryPolicy retryPolicy) {
    ...
    public PagedResult<Kasjer> list(KasjerQueryBuilder query) {
        ...
        return PagedResult.of(
                ...
                p -> {
                    var items = p.getDane();
                    return items == null ? List.of() : items.stream().map(Kasjer::from).toList();
                },
                KasjerzyClient::extractSelfLink,
