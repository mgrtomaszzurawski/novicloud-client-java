 ...
 * @since 1.0.0
 */
public final class SklepyClient {
    ...
    public SklepyClient(ApiClient apiClient, String accountName, RetryPolicy retryPolicy) {
    ...
    public PagedResult<Sklep> list(SklepQueryBuilder query) {
        ...
        return PagedResult.of(
                ...
                p -> {
                    var items = p.getDane();
                    return items == null ? List.of() : items.stream().map(Sklep::from).toList();
                },
                SklepyClient::extractSelfLink,
